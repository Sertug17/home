...
| IDR · Indonesia | IDRX | Verification pending | Issuer confirms the exact Base address and rupiah denomination. Explicitly preserve its token precision. [IDRX](https://docs.idrx.co/introduction/supported-chain-and-contract-address) |
...
| TRY · Türkiye | TRYB · BiLira | Additional verification | Correct issuer/product family, but the registry has two Base contracts with 8 and 6 decimals. Resolve the supported deployment with BiLira before choosing an address. [BiLira](https://www.bilira.co/), [registry](https://dune.com/queries/4780995) |
