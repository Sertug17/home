...
describe("point value validation", () => {
  ...
  test("rejects '0.0e+1'", async () => {
    ...
    expect(page().getByTestId("status").textContent).toBe("empty");
    expect(page().getByTestId("count").textContent).toBe("0");
  });

  test("rejects '0.0e+5'", async () => {
